...
@section('content')
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Ajouter un élève</h3>
        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('group_id',$group,null,['class'=>'form-control','id'=>'datepicker']) !!}
                        @else
                        {!! Form::select('group_id',$group,null,['class'=>'form-control','id'=>'datepicker','placeholder'=>'Vous devez créer un groupe']) !!}
                    @endif
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Liste des élèves ajouter</h3>
        </div>
        <div class="panel-body">
            <table class="table">
                <tr>
